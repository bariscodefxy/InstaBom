...
?>
    <div class="container">
       ...
       <div style="text-align: center;"><em></em><span style="font-size:18px;"><strong> (Reklama Tıkla Bize Yaz +250 İzlenme Kredisi Verelim) </strong></span></div> 
...
<br></br>
    ...
    class="panel panel-default">
                        <div <a style="border-radius:20px;"
    class="panel-heading"> <center><i></i> <i <center><i><img alt="Instagram views" src="/img/play.png" style="height: 18px; width: 18px;"></i></i>
						...
						<div class="proftool">
									...
									<div class="prokredi">
										<div class="kredikt-acik">
											<div class="padder-v"> <span class="block font-bold" id="begeniKrediCount"><?php echo $logonPerson->member["videoKredi"]; ?></span> <small <?php if($isMobile) { ?>style="font-size: 70%;" <?php } ?> class="text-lt font-bold">Kredi</small> </div>
										</div>
										<div class="kredikt-kapali">
											<div class="padder-v"> <span class="block font-bold"><?php echo $item["view_count"]; ?></span> <small <?php if($isMobile) { ?>style="font-size: 70%;" <?php } ?> class="text-lt font-bold">İzlenme Sayısı</small> </div>
										</div>
										<div class="kredikt-acik">
    ...
    name="adet" class="form-control" placeholder="10" value="10">
                                ...
                                <input type="hidden" name="mediaCode" value="<?php echo $item["code"]; ?>">
                                          <center><button type="button" style="border-radius:20px;" id="formBegeniSubmitButton" class="btn btn-warning animated infinite pulse" onclick="sendBegeni();"> İşlemi Başlat</button></center>
                            </form>
                            <div class="cl10"></div>
                            <div id="userList"></div>
                        </div>
