...
?>
    <div class="container">
      ...
      <div style="text-align: center;"><em></em><span style="font-size:18px;"><strong> (Reklama Tıkla Bize Yaz +250 Kaydetme Kredisi Verelim) </strong></span></div> 
...
<br></br>
				<?php if(is_null($media)) { ?>
                    <div <a style="border-radius:20px;" class="panel panel-default">
                        <div <a style="border-radius:20px;" class="panel-heading"><center><i <center><i><img alt="Instagram save" src="/img/save.png" style="height: 18px; width: 18px;"></i></i>
                         Fotoğraf Kaydetme</center>
                        
                        </div>
                        <div class="panel-body">
                            <form method="post" action="?formType=findMediaID" class="form">
                                <div class="form-group">
                                   <center><label>Gönderi Url'si</label></center>
				...
				<?php } else { ?>
                    <div class="panel panel-default">
                        <div class="panel-heading"><center><i></i> <i <center><i><img alt="Instagram save" src="/img/save.png" style="height: 18px; width: 18px;"></i></i>
                          ...
                          <div class="proftool">
									...
									<div class="prokredi">
										<div class="kredikt-acik">
											<div class="padder-v"> <span class="badge" id="saveKrediCount"><?php echo $logonPerson->member["saveKredi"]; ?></span> <small <?php if($isMobile) { ?>style="font-size: 70%;" <?php } ?> class="text-lt font-bold">Kaydetme Gönder</small> </div>
										</div>
